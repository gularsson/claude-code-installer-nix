{
  ...
  outputs = {
    ...
    version = "2.1.126"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-/OlpaNJ1Fh/2WkwZ/GQ078aXPZ9tNdw5kqK6BVPKwY4="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-iKbcphOkBVnzusipRqLsbmCocLkZONPfk9ysHexISMs="; # auto-updated
      };
    };
