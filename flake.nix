{
  ...
  outputs = {
    ...
    version = "2.1.88"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-ztbKyVj6RCW5DmyTQaJnMXFfyxolPVvA9RyNWjpqtm4="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-K6SsFJshmMFeRYN/xQQUbHNfwegrn99xfCprng9wwCw="; # auto-updated
      };
    };
