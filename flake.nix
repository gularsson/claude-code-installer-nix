{
  ...
  outputs = {
    ...
    version = "2.1.159"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-4hJsrwDtPsCTcaKZR2WMfpsxGFJWsqxXKCY72V9+NUE="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-vv0FTwLBfkthpqkrMChqFHyoxcG784uR3RTLpvux4H0="; # auto-updated
      };
    };
