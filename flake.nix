{
  ...
  outputs = {
    ...
    version = "2.1.198"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-cGavQqX+kwOME69QctTANNw5KAkssSH92JLHa5S2uE0="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-mbUKbysfPvB7yvHlii+Yg8RwyE5CivoyGXKxqiA3Lpo="; # auto-updated
      };
    };
