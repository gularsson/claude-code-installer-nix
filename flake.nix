{
  ...
  outputs = {
    ...
    version = "2.1.109"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-1A1Mnv8iS+a6NYb9GwWsw8izJmmY1nSIolndy4Kmvl8="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-argKEeWQVTrYzbjV2T35P7ocquMptI9FOxr5yUtEk9s="; # auto-updated
      };
    };
