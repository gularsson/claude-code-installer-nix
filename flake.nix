{
  ...
  outputs = {
    ...
    version = "2.1.68"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-lpogzEqdluNEkJDtOU7+SEbpIM7F0Sy5zove9eGr5XU="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-SMYxJx3471OjSZdfJ28eLQ7X8Z/4iQQLZUbxbh3xwls="; # auto-updated
      };
    };
