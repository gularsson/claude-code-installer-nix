{
  ...
  outputs = {
    ...
    version = "2.1.104"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-9f6E1LiloyK4OormOsEXrbFD0qmgv9c6IBpSAdZCOGk="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-8KeewwQzRQOlY8bUYYsOofy75HegR905VeIHijxVWcE="; # auto-updated
      };
    };
