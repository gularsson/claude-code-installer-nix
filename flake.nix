{
  ...
  outputs = {
    ...
    version = "2.1.84"; # auto-updated
    platforms = {
      "x86_64-linux" = {
        platform = "linux-x64";
        hash = "sha256-xocqqNuU8wO8akSCZk5A0yiN/JicibomhHPtMuMFWHg="; # auto-updated
      };
      "aarch64-linux" = {
        platform = "linux-arm64";
        hash = "sha256-XIaBdLREOeUcdP8ITDBoVsQXeWFSUNW72qXRAFY2KBQ="; # auto-updated
      };
    };
